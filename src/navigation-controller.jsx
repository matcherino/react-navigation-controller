...
class NavigationController extends React.Component {
  ...
  __transitionViews(options) {
    ...
    this.__transitionViewsComplete = () => {
      ...
      if (typeof this.props.onChange === 'function') {
        this.props.onChange(this.state.views);
      }
    };
  ...
  __renderPrevView() {
    ...
    return React.cloneElement(view, addProps);
  }
  ...
  render() {
    ...
    return (
      <div className={className}>
        <div className={wrapperClassName} ref={'view-wrapper-0'}>
          {this.__renderPrevView()}
        </div>
        <div className={wrapperClassName} ref={'view-wrapper-1'}>
